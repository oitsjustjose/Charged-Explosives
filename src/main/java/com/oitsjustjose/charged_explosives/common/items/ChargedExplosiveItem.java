...
public class ChargedExplosiveItem extends BlockItem {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> components, @NotNull TooltipFlag flag) {
        ...
        int h = tag.getInt("explosionHeight");
        try {
            TranslatableContents wc = new TranslatableContents(ChargedExplosives.MODID + ".width_tooltip", null, new Object[]{w});
            components.add(wc.resolve(null, null, 0));
            TranslatableContents dc = new TranslatableContents(ChargedExplosives.MODID + ".depth_tooltip", null, new Object[]{d});
            components.add(dc.resolve(null, null, 0));
            TranslatableContents hc = new TranslatableContents(ChargedExplosives.MODID + ".height_tooltip", null, new Object[]{h});
